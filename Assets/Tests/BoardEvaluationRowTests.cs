...
namespace BoardEvaluationTests
{
    ...
    class BoardEvaluationRowTests
    {
        ...
        {
            World.CreateSystem<BoardEvaluationRowsSystem>().Update();
        ...
        [Test]
        public void FindMatchInRow_SingleRowBoard_FullRowMatch()
        {
        ...
        [Test]
        public void FindMatchInRow_SingleRowBoard_MinMatchSizeLessThanRowSize()
        {
            var boardArray = new OwnerComponent[,]
            {
                { Team.EMPTY, Team.X,  Team.X, Team.X, Team.EMPTY },
            };
        ...
        [Test]
        public void FindMatchInRow_SingleRowBoard_MatchSizeGreaterThanMin()
        {
            var boardArray = new OwnerComponent[,]
            {
                { Team.X, Team.X, Team.X, Team.X, Team.X, },
            };
            var matchSize = 1;
        ...
        [Test]
        public void FindMatchInRow_SingleRowBoard_MatchSizeSmallerThanMin()
        {
            var boardArray = new OwnerComponent[,]
            {
                { Team.X, Team.X, Team.EMPTY,},
            };
            var matchSize = 3;
        ...
        [Test]
        public void FindMatchInRow_SingleRowBoard_MatchSizeSmallerThanMinAndRowSizeLessThanMatchSize()
        {
            var boardArray = new OwnerComponent[,]
            {
               { Team.X, }
        ...
        [Test]
        public void FindMatchInRow_SingleRowBoard_EmptyBoard()
        {
            var boardArray = new OwnerComponent[,]
            {
        ...
        [Test]
        public void FindMatchInRow_SingleRowBoard_MultipleMatches()
        {
            var boardArray = new OwnerComponent[,]
            {
                { Team.X, Team.X, Team.EMPTY, Team.X, Team.X, Team.EMPTY, Team.X, Team.X, Team.X,  Team.X, Team.EMPTY, Team.X, Team.X, },
            };
            var matchSize = 2;
        ...
        [Test]
        public void FindMatchInRow_ZeroSizeBoard()
        {
            var boardArray = new OwnerComponent[,]
            {
            };
        ...
        [Test]
        public void FindMatchInRow_MultiRowBoard_NoMatches()
        {
            var boardArray = new OwnerComponent[,]
            {
                { Team.X, Team.X, Team.EMPTY, },
        ...
        public void FindMatchInColumn_MultiColumnBoard_OneMatch()
        {
            ...
            Assert.AreEqual(matches.Length, 1);
            Assert.AreEqual(matches[0].team, Team.X);
            Assert.AreEqual(matches[0].startIndex, 3);
            Assert.AreEqual(matches[0].endIndex, 5);
        ...
        public void FindMatchInColumn_MultiColumnBoard_MultipleMatches()
        {
            ...
            Assert.IsTrue(Array.Exists(matchesArray, match => match.team == Team.O && match.startIndex == 0 && match.endIndex == 1));
            Assert.IsTrue(Array.Exists(matchesArray, match => match.team == Team.X && match.startIndex == 3 && match.endIndex == 5));
            Assert.IsTrue(Array.Exists(matchesArray, match => match.team == Team.X && match.startIndex == 6 && match.endIndex == 7));
